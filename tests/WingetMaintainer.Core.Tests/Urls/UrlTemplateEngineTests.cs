...
public sealed class UrlTemplateEngineTests
{
    ...
    public void Expand_SimpleVersion_ReplacesAndHasNoArchitecture()
    {
        ...
        IReadOnlyList<InstallerUrl> result = UrlTemplateEngine.Expand(template, new UrlTemplateValues("1.2.3"));
    ...
    public void Expand_MultipleUrlsWithArchitectureSuffix_ParsesEachArchitecture()
    {
        ...
        IReadOnlyList<InstallerUrl> result = UrlTemplateEngine.Expand(template, new UrlTemplateValues("27.0.0"));
